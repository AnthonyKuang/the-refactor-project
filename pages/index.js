  ...
  return (
    <Layout page='home'>
      ...
      <section className='container-homepage mx-auto px-6 text-center'>
        <p className='mt-20 sm:mt-28 xl:mt-32 inline-block bg-gradient-to-r text-transparent bg-clip-text from-blue-400 to-blue-600 uppercase text-sm sm:text-base md:text-lg lg:text-xl font-medium tracking-wider'>
