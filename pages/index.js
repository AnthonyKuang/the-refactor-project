...
export default function Home() {
  return (
    <Layout page='home'>
      ...
      <section className='relative container-homepage mx-auto px-6 text-center'>
        ...
        <p className='mt-14 max-w-lg mx-auto text-base sm:text-lg md:text-xl leading-loose sm:leading-loose md:leading-loose'>
          We transform the web by crafting responsive and performant websites to
          users on all devices.
        </p>
        <a
          href='#LINK'
          className='mt-32 sm:mt-72 block max-w-xs sm:max-w-sm md:max-w-md mx-auto border-blue-400 border-2 bg-blue-400 text-white font-medium uppercase rounded-md py-3 transition duration-200 hover:bg-white hover:text-blue-400'
        >
          Request a website
        </a>
      </section>
