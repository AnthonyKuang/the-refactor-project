...
export default function Footer() {
  return (
    <footer className='mt-96 border-t-4 border-gray-100'>
      ...
      <section className='bg-gray-50 border-t border-gray-200 pt-20'>
        ...
        <div className='mt-16 py-8 container-homepage flex justify-between items-center border-t-2 border-gray-200'>
          ...
          <div className='text-gray-400 flex gap-3'>
            <svg
              ...
              height='24'
              viewBox='0 0 24 24'
              className='fill-current transition-colors hover:text-gray-600'
            >
